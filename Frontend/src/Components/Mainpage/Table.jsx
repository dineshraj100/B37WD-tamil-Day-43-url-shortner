...
export function AllocationTableComp() {
  ...
  const APIFrontShow = 'heartfelt-genie-f4120b.netlify.app';
              ...
              {tableData !== 'initial' &&
                ...
                tableData.map((row, index) => (
                  <StyledTableRow key={`${index}`}>
                    ...
                    <StyledTableCell
                      style={{ minHeight: '38px', textAlign: 'left' }}
                    >
                      <a
                    ...
                    <StyledTableCell
                      style={{ minHeight: '38px', textAlign: 'center' }}
                    >
                    ...
                    <StyledTableCell
                      style={{ minHeight: '38px', textAlign: 'center' }}
                    >
                      <Button onClick={() => handleInfo(row.shortUrl)}>
                        <InfoIcon />
                      </Button>
                    </StyledTableCell>
                  </StyledTableRow>
